...
export const ZonesPanel = ({
  ...
  return (
    <div className="space-y-3 md:space-y-4">
      ...
      <section>
        <div className="max-h-144 space-y-2.5 overflow-y-auto pr-1 md:space-y-3 xl:max-h-160">
          ...
          {zones.length === 0 ? <p className="text-sm text-base-content/60">No active zones configured.</p> : null}
        </div>
      </section>
    </div>
  );
